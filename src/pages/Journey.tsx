        ...
        <div className="flex justify-end mb-8">
          {user ? (
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 px-4 py-2 bg-green-900/30 border border-green-600/30 rounded-lg">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-red-600/20 border border-red-600/30 hover:bg-red-600/30 transition-colors text-red-400 hover:text-red-300"
              >
